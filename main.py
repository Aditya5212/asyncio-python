...
def sync_function(test_param: str):
...
async def main():
    ...
    # print(f"finished result: {future}")
    # print(future_result)

    # Coroutines are the functions whoes execution we can stop, and the coroutine returns a awaitable coroutine_obj
